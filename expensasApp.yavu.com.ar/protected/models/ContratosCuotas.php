...
/**
 * This is the model class for table "contratos_cuotas".
 *
 * The followings are the available columns in table 'contratos_cuotas':
 * @property integer $id
 ...
 */
class ContratosCuotas extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ContratosCuotas the static model class
	 */
	 public $buscar;
