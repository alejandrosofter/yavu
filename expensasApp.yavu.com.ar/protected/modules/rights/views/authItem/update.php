...
<div id="updatedAuthItem">
	...
	<h2><?php echo Rights::t('core', 'Actualizar :name', array(
		':name'=>$model->name,
	...
	<div class="relations span-11 last">
		...
		<h3><?php echo Rights::t('core', 'Relaciones'); ?></h3>

		<?php if( $model->name!==Rights::module()->superuserName ): ?>

			<div class="parents">

				<h4><?php echo Rights::t('core', 'Padres'); ?></h4>

				<?php $this->widget('zii.widgets.grid.CGridView', array(
					'dataProvider'=>$parentDataProvider,
					'template'=>'{items}',
					'hideHeader'=>true,
					'emptyText'=>Rights::t('core', 'Este articulo no tiene padres.'),
