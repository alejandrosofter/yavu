...
class AuditTrail extends CActiveRecord
{
	...
	public function search($options = array())
	{
		...
		$criteria->select = "t.*, usuarios.nombre as nombreUsuario,GROUP_CONCAT(' Valor Anterior: ',t.old_value,' Nuevo Valor: ',t.new_value,' Accion: ',t.action,' Modulo: ',t.model SEPARATOR '<br>') as estados";
		...
		$criteria->join = "LEFT JOIN usuarios on usuarios.idUsuario = t.user_id" ;
		$criteria->group='t.stamp';
