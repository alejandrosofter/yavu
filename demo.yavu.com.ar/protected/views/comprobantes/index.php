...
array('value'=>'"$ ".number_format($data->bonificacion)', 'header'=>'Bonif.'), 
array('value'=>'"$ ".number_format($data->interes)', 'header'=>'Interés'), 
array('type'=>'html','value'=>'"$ ".number_format($data->importeTotal,2)', 'header'=>'Importe'), 
array('value'=>'"$ ".number_format($data->importePagado)', 'header'=>'Pagado'),
