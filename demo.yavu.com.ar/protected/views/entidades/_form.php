...
<div class='span5'>
	...
	<p class="text-warning">El campo <b>email</b> será el nombre de usuario WEB</p>
	<?php echo $form->textFieldRow($model,'claveWeb',array('class'=>'span3','maxlength'=>255)); ?>
	<p class="text-warning">La clave puede ser en blanco</p>
