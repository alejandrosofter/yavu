...
$this->widget(
    ...
    array(
        ...
        'tabs' => array(
            array('label' => 'General','active'=>true, 'content' => $this->renderPartial('_datosGral',array('form'=>$form,'model'=>$model,'idInquilino'=>$idInquilino,'idPropietario'=>$idPropietario),true)),
