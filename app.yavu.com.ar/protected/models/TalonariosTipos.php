...
class TalonariosTipos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipoOperacion,proximo', 'numerical'),
			array('nombreTipoTalonario,proximo,esPredeterminado,letraTalonario,tipoElectronico', 'length', 'max'=>200),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('buscar,id,letraTalonario,tipoElectronico,esPredeterminado,proximo, nombreTipoTalonario, tipoOperacion', 'safe', 'on'=>'search'),
		);
	}
