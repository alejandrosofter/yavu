...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->datepickerRow($model,'fecha',array('options'=>array(),'htmlOptions'=>array('class'=>'span2')),array('prepend'=>'<i class="icon-calendar"></i>','append'=>'')); ?>
			...
			<?php echo $form->select2Row($model,'idFormaPago',array('data'=>CHtml::listData(PagosFormas::model()->findAll(), 'id', 'nombreFormaPago'),'htmlOptions'=>array('onchange'=>''),'options'=>array('placeholder'=>'Seleccione...')),array('class'=>'span5')); ?>
