...
<div class="">
	...
	<div class="">
		<b><?php echo 'PUNTO VENTA' ?></b>
		<?php echo CHtml::textField('DATOS_EMPRESA_PUNTOVENTACOMUN',Settings::model()->getValorSistema('DATOS_EMPRESA_PUNTOVENTACOMUN'),array('class'=>'span1','maxlength'=>255)); 
