...
class SwiftMailer extends CComponent
{
	...
	protected $_attachmentsData = array();
	...
	public function AddFileData($address)
	{
		if (!in_array($address, $this->_attachmentsData))
			$this->_attachmentsData[] = $address;
		return $this;
	}
	...
	public function Send()
	{
		...
		if ($this->_attachmentsData) {
			foreach ($this->_attachmentsData as $data)
				$message->attach(Swift_Attachment::newInstance($data,'comprobante.pdf'));
		}
